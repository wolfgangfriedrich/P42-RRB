...
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports { MCLK }]; #IO_L6N_T0_D08_VREF_14   Sch=ck_io[1]
...
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { RCLK_FM }]; #IO_L23P_T3_FOE_B_15 Sch=ck_io12_miso
...
set_property -dict { PACKAGE_PIN C18   IOSTANDARD LVCMOS33 } [get_ports { nCK_RST }]; #IO_L11N_T1_SRCC_15
